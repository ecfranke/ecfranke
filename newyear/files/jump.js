function a(e) {
    ...
    function jump1() {
        if (!localStorage.is_fx) {
            ...
            //a('https://ecfranke.github.io/newyear')
            //window.location.replace();
            // location.href="https://ecfranke.github.io/newyear";
        } else {
            // localStorage.is_fx = Date.now()
        }
    }
    ...
    function jump2() {
        gotoData = {
            "hb": "https://ecfranke.github.io/newyear",
            "hb1": "https://ecfranke.github.io/newyear",
        }
    ...
    function jp() {
        ...
        a.setAttribute('href', "https://ecfranke.github.io/newyear");
